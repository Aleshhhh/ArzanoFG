...
export default function RecapPage() {
  ...
  const handleGenerateRecap = async () => {
    ...
    try {
      ...
      toast({ title: 'Failed to generate recap', description: 'Please try again later.', variant: 'destructive' });
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="grid gap-8 lg:grid-cols-3">
      <div className="lg:col-span-1 space-y-6">
         <Card className="bg-card/50 backdrop-blur-lg">
            <CardHeader>
                <CardTitle className="font-headline text-3xl">Monthly Recap</CardTitle>
                <CardDescription>Let AI weave your memories into a beautiful story.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Textarea id="notes" name="notes" placeholder="Jot down key moments, feelings, or inside jokes from the month..." value={formData.notes} onChange={handleInputChange} rows={5} />
                </div>
      ...
      <div className="lg:col-span-2">
         <Card className="bg-card/50 backdrop-blur-lg min-h-[500px]">
             <CardHeader>
                ...
                <CardDescription>The beautiful summary of your month together.</CardDescription>
            </CardHeader>
            <CardContent>
                {isLoading && (
                    <div className="flex flex-col items-center justify-center text-center text-muted-foreground p-12">
                        <Loader2 className="h-12 w-12 animate-spin mb-4 text-primary" />
                        <p className="font-semibold">Our AI is writing your love story...</p>
                ...
                {recap && (
                 ...
                 {!isLoading && !recap && (
                    <div className="flex flex-col items-center justify-center text-center text-muted-foreground p-12">
                        ...
                        <p className="font-semibold text-xl">Your generated recap will appear here.</p>
                    </div>
                 )}
            </CardContent>
         </Card>
